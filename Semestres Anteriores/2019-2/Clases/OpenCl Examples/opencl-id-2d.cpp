...
"       e[el] = get_global_id(1);  \n"
"       f[el] = get_local_id(1);   \n"
"       g[el] = get_group_id(1);   \n"
"       h[el] = get_local_size(1); \n"
"   }                              \n"
"}                                 \n"
;
...
int main() {
    ...
    err = clSetKernelArg(mykernel, 8, sizeof(cl_mem), (void *)&nCol); assert(err == 0);
